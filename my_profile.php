            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <a class="btn btn-primary" href="my_logout.php" role="button">Logout</a>
                </ul>
              </div>
            </div>
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info" data-bs-toggle="modal" data-bs-target="#updateModal<?= $user['id']?>">Update</a>
                      <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $user['id']?>">delete</a>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="validationCustom01" class="form-label">First Name</label>
                                                             <input name="first" type="text" class="form-control"                                                               
                                                                ...
                                                                ?>                                                                                                                        
                                                            id="validationCustom01" placeholder="<?php $user['first']?>" required>                                                           
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="validationCustom02" class="form-label">Last Name</label>
                                                             <input name="last" type="text" class="form-control"                                                               
                                                                ...
                                                                ?>                                                                                                                        
                                                            id="validationCustom02" placeholder="<?php $user['last']?>" required>                                                           
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="validationCustom03" class="form-label">Phone #</label>
                                                             <input name="phone" type="text" class="form-control"                                                               
                                                                ...
                                                                ?>                                                                                                                        
                                                            id="validationCustom03" placeholder="<?php $user['phone']?>" required>                                                           
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="validationCustom04" class="form-label">Address</label>
                                                             <input name="address" type="text" class="form-control"                                                               
                                                                ...
                                                                ?>                                                                                                                        
                                                            id="validationCustom04" placeholder="<?php $user['address']?>" required>                                                           
                                                        </div>
